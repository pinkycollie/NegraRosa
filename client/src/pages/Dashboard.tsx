...
import { ArrowUpRight, TrendingUp, Award, Users, Info } from "lucide-react";
...
export default function Dashboard({ userId }: DashboardProps) {
  ...
  const [showAboutPlatform, setShowAboutPlatform] = useState<boolean>(true);
  ...
  return (
    <div className="bg-background min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-6 flex-1">
        ...
        {!showAboutPlatform && (
          <div className="bg-primary/10 rounded-lg p-4 mb-6 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <p className="text-sm">
                Learn about our mission, how the platform works, and our commitment to transparency.
              </p>
            </div>
            <Button 
              variant="ghost" 
              size="sm" 
              onClick={() => setShowAboutPlatform(true)}
        ...
        {/* About Platform Section (Collapsible) */}
        {showAboutPlatform && (
          <AboutPlatform onClose={() => setShowAboutPlatform(false)} />
        )}
        
        {/* Sticky Navigation Menu */}
        <div className="sticky top-0 z-40 bg-background pt-2 pb-2">
